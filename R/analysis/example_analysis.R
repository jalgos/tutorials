...
## project/data: this folder should contain the ESPNFC files. They can be found on Jalgos drive: https://drive.google.com/a/jalgos.com/folderview?id=0B1ej3OAh42ovYWtQaV81bnZvcTQ&usp=sharing
## project/analysis: a folder analysis containing the present script and espnfc.R
